...
function last() {
  ...
  if (page == pageCount) {
    ...
    form.action = "log.jsp?page=" + form.pageCount.value;
    form.submit();
  }
}
...
function pre() {
  ...
  if (page <= 1) {
    ...
    form.action = "log.jsp?page=" + (page - 1);
    form.submit();
  }
}
...
function bjump() {
  ...
  if (form.busjump.value > pageCount) {
    if (pageCount == 0) {
      ...
      form.action = "log.jsp?page=" + pageCount;
      form.submit();
    }
