function home() {
  ...
  if (page <= 1) {
    ...
    form.action = "search_card_info1.jsp?page=1";
    form.submit();
  }
}
...
function last() {
  ...
  if (page == pageCount) {
    ...
    form.action = "search_card_info1.jsp?page=" + form.pageCount.value;
    form.submit();
  }
}
...
function pre() {
  ...
  if (page <= 1) {
    ...
    form.action = "search_card_info1.jsp?page=" + (page - 1);
    form.submit();
  }
}
...
function bjump() {
  ...
  if (form.busjump.value > pageCount) {
    if (pageCount == 0) {
      ...
      form.action = "search_card_info1.jsp?page=" + pageCount;
      form.submit();
    }
    ...
    if (page == 0) {
      page = 1;
      form.action = "search_card_info1.jsp?page=" + page;
      form.submit();
    } else {
      form.action = "search_card_info1.jsp?page=" + page;
      form.submit();
