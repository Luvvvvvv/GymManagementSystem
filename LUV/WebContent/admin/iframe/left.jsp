...
<div id="my_menu" class="sdmenu">
	...
	<div class="collapsed">
		...
		<a href="<%=basePath %>/admin/systemmanager/add_coach.jsp?method=addxs" target="MainFrame">增加健身教练</a>
	</div>
	
	<div class="collapsed">
		<span>管理人员管理</span>
		<a href="<%=basePath %>/admin/systemmanager/manage_manager.jsp" target="MainFrame">管理人员</a>
		<a href="<%=basePath %>/admin/systemmanager/add_manager.jsp?method=addm" target="MainFrame">增加管理人员</a>
	</div> 
	
	<div class="collapsed">
		<span>系统数据管理</span>
		<a href="<%=basePath %>/admin/systemmanager/backup.jsp" target="MainFrame">数据备份管理</a>
		<a href="<%=basePath %>/admin/systemmanager/log.jsp?method=addxs" target="MainFrame">系统日志管理</a>
	</div>

	<%}else if(sf.equals("管理人员")){ %>
	<div class="collapsed">
		<span>个人信息管理</span>
	...
	<div class="collapsed">
		<span>通知信息管理</span>
		<a href="<%=basePath %>/admin/manager/add_notice.jsp?method=addtz" target="MainFrame">增加通知信息</a>
	...
	<div class="collapsed">
		<span>文件信息管理</span>
		<a href="<%=basePath %>/admin/manager/add_file.jsp?method=addwj" target="MainFrame">增加文件信息</a>
		<a href="<%=basePath %>/admin/manager/manage_file.jsp" target="MainFrame">文件信息管理</a>
	</div>

	<%}else if(sf.equals("健身教练")){ %>
	<div class="collapsed">
		<span>个人信息管理</span>
		<a href="<%=basePath %>/admin/systemmanager/modifypsw.jsp" target="MainFrame">修改密码</a>
	...
	<div class="collapsed">
		<span>办卡人员管理</span>
		<a href="<%=basePath %>/admin/coach/add_card.jsp?method=addxm" target="MainFrame">办卡人员添加</a>
	...
	<div class="collapsed">
		<span>私教课程管理</span>
		<a href="<%=basePath %>/admin/coach/add_member.jsp?method=addcg" target="MainFrame">私教课程添加</a>
	...
	<div class="collapsed">
		<span>反馈信息</span>
		<a href="<%=basePath %>/admin/coach/add_feedback.jsp?method=addfk" target="MainFrame">提交反馈信息</a>
