    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr style="text-align: center;height: 40px;font-size: 16px;">
          <td width="100px"><strong>序号</strong></td>
          <td width="200px"><strong>反馈标题</strong></td>
          <td width="700px"><strong>反馈内容</strong></td>
          <td width="100px"><strong>时间</strong></td>
          <td width="100px"><strong>反馈用户</strong></td>
          <td width="80px"><strong>操作</strong></td>
        </tr>
        <%
          cb.setEVERYPAGENUM(8);
          int cou = cb.getMessageCount("select count(*) from feedback where users='" + username + "'");
          ...
          List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from feedback where users='" + username + "' order by id desc", 5);
