...
<div class="right_cont">
  <div class="title_right"><strong>通知信息</strong></div>
    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr style="text-align: center;height: 40px;font-size: 16px;">
          ...
          <td width="550px"><strong>通知内容</strong></td>
          <td width="100px"><strong>发布时间</strong></td>
          <td width="80px"><strong>发布用户</strong></td>
        </tr>
        <%
          cb.setEVERYPAGENUM(8);
          int cou = cb.getMessageCount("select count(*) from notice");
          ...
          List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from notice order by id desc", 5);
