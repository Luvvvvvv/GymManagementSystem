    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <% String word = Common.toChineseAndTrim(request.getParameter("word"));
          ...
          int cou = cb.getMessageCount("select count(*) from members where name like '%" + word + "%' and users='" + username + "'");
          ...
          List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from members where name like '%" + word + "%' and users='" + username + "' order by id desc", 8);
        ...
        <tr style="text-align: center">
          <td nowrap="nowrap" colspan="16">
            ...
            第<input name="busjump" type="text" class="span1"/>页 <a href="#" onClick="bjump2()">跳转</a>&nbsp;&nbsp;&nbsp;
          </td>
        </tr>
        </tbody>
      </table>
