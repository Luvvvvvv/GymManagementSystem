...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>admin/coach/file.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>admin/coach/file.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>admin/coach/file.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>admin/coach/file.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>admin/coach/file.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>admin/coach/file.jsp?page=" + page;
                form3.submit();
...
<div class="right_cont">
    <div class="title_right"><strong>文件信息查看</strong></div>
        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap" width="250px"><strong>文件名称</strong></td>
                    <td nowrap="nowrap" width="50px"><strong>下载</strong></td>
                    <td nowrap="nowrap" width="400px"><strong>文件说明</strong></td>
                    <td nowrap="nowrap" width="50px"><strong>时间</strong></td>
                    <td nowrap="nowrap" width="50px"><strong>上传用户</strong></td>
                </tr>
                <%
                    cb.setEVERYPAGENUM(12);
                    int cou = cb.getMessageCount("select count(*) from files where dw='" + dw + "'");//得到信息总数
                    ...
                    List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from files where dw='" + dw + "' order by id desc", 7);
