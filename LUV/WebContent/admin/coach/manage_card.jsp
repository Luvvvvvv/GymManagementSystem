...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where yh='"+username+"'");   //得到信息总数
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where yh='"+username+"' order by id desc",18);
