...
<%
	...
	int cou = cb.getMessageCount("select count(*) from admin where sf ='管理人员'");//得到信息总数
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where sf ='管理人员' order by id desc",10);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap"><a href="<%=basePath%>admin/systemmanager/add_manager.jsp?method=upm&id=<%=pagelist2.get(0).toString()%>">修改</a>
