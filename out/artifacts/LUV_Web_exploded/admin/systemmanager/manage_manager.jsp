      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr id="tr2">
          ...
          <td nowrap="nowrap">
            ...
            <div id="deleteSet">
              <a href="<%=basePath%>AdminServlet?method=delmanager&id=<%=pagelist2.get(0).toString()%>" id="delete">删除</a>
            </div>
          </td>
        </tr>
        <% }
...
<script type="text/javascript" src="<%=basePath %>/assets/pagescript/manage_manager.js"></script>
