...
<script language="javascript">
  function top2() {
    form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=1";
    form3.submit();
  }
  ...
  function last2() {
    if (form3.pageCount.value == 0) {
      ...
      form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=" + form3.pageCount.value;
      form3.submit();
    }
  }
  ...
  function pre2() {
    ...
    if (page <= 1) {
      ...
      form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=" + (page - 1);
      form3.submit();
    }
  }
  ...
  function bjump2() {
    ...
    if (form3.busjump.value > pageCount) {
      if (pageCount == 0) {
        ...
        form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=" + pageCount;
        form3.submit();
      }
      ...
      if (page == 0) {
        page = 1;
        form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=" + page;
        form3.submit();
      } else {
        form3.action = "<%=basePath%>admin/systemmanager/log.jsp?page=" + page;
        form3.submit();
        ...
        <tr style="text-align: center;height: 28px;font-size: 14px;">
          ...
          <td nowrap="nowrap">
            <a href="<%=basePath%>ComServlet?method=delrz&id=<%=pagelist2.get(0).toString()%>"
               style="color: white;background-color: #f56c6c;padding: 3px;border-radius: 5px;text-decoration: none;">删除</a></td>
        </tr>
        <% }
        } %>
