...
<div class="right_cont">
  <div class="title_right"><strong>文件信息</strong></div>
  <div id="table_frame">
      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr id="tr2">
          ...
          <td nowrap="nowrap" id="downloadSet">
            <a href="<%=basePath%>down.jsp?url=<%=pagelist2.get(2).toString()%>" id="download">下载</a>
          </td>
...
<script type="text/javascript" src="<%=basePath %>/assets/pagescript/file.js"></script>
