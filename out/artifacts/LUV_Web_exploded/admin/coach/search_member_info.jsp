...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>/admin/coach/search_member_info.jsp?page=" + page;
                form3.submit();
        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap"><strong>课程内容</strong></td>
                    <td nowrap="nowrap"><strong>课程目标</strong></td>
                    <td nowrap="nowrap"><strong>课程节数/已完成节数</strong></td>
                    <td nowrap="nowrap"><strong>私教合同下载</strong></td>
                    <td nowrap="nowrap"><strong>课程负责人</strong></td>
                ...
                <% String word = Common.toChineseAndTrim(request.getParameter("word"));
                    ...
                    List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from members where name like '%" + word + "%' and users='" + username + "' order by id desc", 9);
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap"><a href="<%=basePath%>down.jsp?url=<%=pagelist2.get(5).toString()%>">下载</a>
                    </td>
                    ...
                    <td nowrap="nowrap">
                        <a href="<%=basePath%>admin/coach/add_member.jsp?method=upmembers&id=<%=pagelist2.get(0).toString()%>">修改</a>
                        <a href="<%=basePath%>ComServlet?method=delmembers&id=<%=pagelist2.get(0).toString()%>">删除</a>
                    </td>
                </tr>
                <% }
                } %>
                <tr align="center">
                    <td nowrap="nowrap" colspan="16"><input type="hidden" name="word" value="<%=word%>"/>
