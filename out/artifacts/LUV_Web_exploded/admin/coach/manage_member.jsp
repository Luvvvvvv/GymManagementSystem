...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from cg where yh='"+username+"'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from cg where yh='"+username+"' order by id desc",13);
