...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>admin/coach/manage_feedback.jsp?page=" + page;
                form3.submit();
    ...
    <div style="width:100%;margin:auto;">
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                <tbody>
                <tr align="center">
                    <td nowrap="nowrap" width="50px"><strong>序号</strong></td>
                    <td nowrap="nowrap" width="100px"><strong>反馈标题</strong></td>
                    <td nowrap="nowrap" width="700px"><strong>反馈内容</strong></td>
                    <td nowrap="nowrap" width="50px"><strong>时间</strong></td>
                    <td nowrap="nowrap" width="50px"><strong>反馈用户</strong></td>
                    <td nowrap="nowrap" width="80px"><strong>操作</strong></td>
                </tr>
                <%
                    cb.setEVERYPAGENUM(12);
                    int cou = cb.getMessageCount("select count(*) from feedback ");//得到信息总数
                    ...
                    List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from feedback order by id desc", 6);
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap">
                        <a href="<%=basePath%>admin/coach/add_feedback.jsp?method=upfeedback&id=<%=pagelist2.get(0).toString()%>">修改</a>
                        <a href="<%=basePath%>ComServlet?method=delfeedback&id=<%=pagelist2.get(0).toString()%>">删除</a>
                    </td>
                </tr>
                <% }
                } %>
