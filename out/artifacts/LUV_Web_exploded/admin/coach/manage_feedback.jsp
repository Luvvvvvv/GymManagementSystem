    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr style="text-align: center;height: 28px;font-size: 14px;">
          ...
          <td nowrap="nowrap">
            <a href="<%=basePath%>admin/coach/add_feedback.jsp?method=upfeedback&id=<%=pagelist2.get(0).toString()%>"
               style="color: white;background-color: #85ce61;padding: 3px;border-radius: 5px;text-decoration: none;">修改</a>
            <a href="<%=basePath%>ComServlet?method=delfeedback&id=<%=pagelist2.get(0).toString()%>"
