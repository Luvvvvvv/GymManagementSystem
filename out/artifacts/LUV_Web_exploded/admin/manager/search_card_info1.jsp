...
<script language="javascript">
  ...
  function last2() {
    if (form3.pageCount.value == 0) {
      ...
      form3.action = "<%=basePath%>admin/manager/search_card_info1.jsp?page=" + form3.pageCount.value;
      form3.submit();
    }
  }
  ...
  function pre2() {
    ...
    if (page <= 1) {
      ...
      form3.action = "<%=basePath%>admin/manager/search_card_info1.jsp?page=" + (page - 1);
      form3.submit();
    }
  }
  ...
  function bjump2() {
    ...
    if (form3.busjump.value > pageCount) {
      if (pageCount == 0) {
        ...
        form3.action = "<%=basePath%>admin/manager/search_card_info1.jsp?page=" + pageCount;
        form3.submit();
      }
      ...
      if (page == 0) {
        page = 1;
        form3.action = "<%=basePath%>admin/manager/search_card_info1.jsp?page=" + page;
        form3.submit();
      } else {
        form3.action = "<%=basePath%>admin/manager/search_card_info1.jsp?page=" + page;
        form3.submit();
