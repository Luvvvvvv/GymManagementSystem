...
<script language="javascript">
  function top2() {
    form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=1";
    form3.submit();
  }
  ...
  function last2() {
    if (form3.pageCount.value == 0) {
      ...
      form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=" + form3.pageCount.value;
      form3.submit();
    }
  }
  ...
  function pre2() {
    ...
    if (page <= 1) {
      ...
      form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=" + (page - 1);
      form3.submit();
    }
  }
  ...
  function bjump2() {
    ...
    if (form3.busjump.value > pageCount) {
      if (pageCount == 0) {
        ...
        form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=" + pageCount;
        form3.submit();
      }
      ...
      if (page == 0) {
        page = 1;
        form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=" + page;
        form3.submit();
      } else {
        form3.action = "<%=basePath%>/admin/manager/search_member_info1.jsp?page=" + page;
        form3.submit();
    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <% String word = Common.toChineseAndTrim(request.getParameter("word"));
          ...
          int cou = cb.getMessageCount("select count(*) from members where name like '%" + word + "%' ");
          ...
          List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from members where name like '%" + word + "%' order by id desc", 8);
