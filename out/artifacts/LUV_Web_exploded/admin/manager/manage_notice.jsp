...
<%   
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from tz order by id desc",6);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/manager/add_notice.jsp?method=uptz&id=<%=pagelist2.get(0).toString()%>">修改</a>
