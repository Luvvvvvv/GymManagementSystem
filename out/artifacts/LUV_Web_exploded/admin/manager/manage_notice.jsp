        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap"><strong>通知标题</strong></td>
                    <td nowrap="nowrap"><strong>通知内容</strong></td>
                    <td nowrap="nowrap"><strong>时间</strong></td>
                    <td nowrap="nowrap"><strong>发布用户</strong></td>
                    <td width="80" nowrap="nowrap"><strong>操作</strong></td>
                </tr>
                <%
                    cb.setEVERYPAGENUM(12);
                    int cou = cb.getMessageCount("select count(*) from notice ");//得到信息总数
                    ...
                    List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from notice order by id desc", 6);
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap">
                        <a href="<%=basePath%>admin/manager/add_notice.jsp?method=upnotice&id=<%=pagelist2.get(0).toString()%>">修改</a>
                        <a href="<%=basePath%>ComServlet?method=delnotice&id=<%=pagelist2.get(0).toString()%>">删除</a>
                    </td>
                </tr>
                <% }
                } %>
