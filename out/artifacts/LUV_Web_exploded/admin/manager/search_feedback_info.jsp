...
<script language="javascript">
  function top2() {
    form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=1";
    form3.submit();
  }
  ...
  function last2() {
    if (form3.pageCount.value == 0) {
      ...
      form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=" + form3.pageCount.value;
      form3.submit();
    }
  }
  ...
  function pre2() {
    ...
    if (page <= 1) {
      ...
      form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=" + (page - 1);
      form3.submit();
    }
  }
  ...
  function bjump2() {
    ...
    if (form3.busjump.value > pageCount) {
      if (pageCount == 0) {
        ...
        form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=" + pageCount;
        form3.submit();
      }
      ...
      if (page == 0) {
        page = 1;
        form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=" + page;
        form3.submit();
      } else {
        form3.action = "<%=basePath%>admin/manager/search_feedback_info.jsp?page=" + page;
        form3.submit();
    ...
    <form action="" method="post" name="form3">
      <table class="table table-bordered table-striped table-hover">
        ...
        <tr style="text-align: center;height: 40px;font-size: 16px;">
          ...
          <td nowrap="nowrap"><strong>反馈标题</strong></td>
          <td nowrap="nowrap"><strong>反馈内容</strong></td>
          <td nowrap="nowrap"><strong>时间</strong></td>
          <td nowrap="nowrap"><strong>反馈用户</strong></td>
        ...
        <% String word = Common.toChineseAndTrim(request.getParameter("word"));
          ...
          int cou = cb.getMessageCount("select count(*) from feedback where title like '%" + word + "%'");
          ...
          List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from feedback where title like '%" + word + "%' order by id desc", 5);
        ...
        <tr style="text-align: center;height: 28px;font-size: 14px;">
          ...
          <td nowrap="nowrap">
            <a href="<%=basePath%>ComServlet?method=delfeedback1&id=<%=pagelist2.get(0).toString()%>"
