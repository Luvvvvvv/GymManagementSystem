...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>admin/manager/manage_card1.jsp?page=" + page;
                form3.submit();
        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap"><a
                            href="<%=basePath%>ComServlet?method=delcards1&id=<%=pagelist2.get(0).toString()%>">删除</a>
                    </td>
                </tr>
                <% }
                } %>
