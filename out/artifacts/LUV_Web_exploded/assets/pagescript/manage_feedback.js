function home() {
  ...
  if (page <= 1) {
    ...
    form.action = "manage_feedback.jsp?page=1";
    form.submit();
  }
}
...
function last() {
  ...
  if (page == pageCount) {
    ...
    form.action = "manage_feedback.jsp?page=" + form.pageCount.value;
    form.submit();
  }
}
...
function pre() {
  ...
  if (page <= 1) {
    ...
    form.action = "manage_feedback.jsp?page=" + (page - 1);
    form.submit();
  }
}
...
function bjump() {
  ...
  if (form.busjump.value > pageCount) {
    if (pageCount == 0) {
      ...
      form.action = "manage_feedback.jsp?page=" + pageCount;
      form.submit();
    }
    ...
    if (page == 0) {
      page = 1;
      form.action = "manage_feedback.jsp?page=" + page;
      form.submit();
    } else {
      form.action = "manage_feedback.jsp?page=" + page;
      form.submit();
